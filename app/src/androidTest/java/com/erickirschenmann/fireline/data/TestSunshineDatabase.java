...
public class TestSunshineDatabase {
  ...
  public void before() {
    try {
      ...
      Constructor incidentDbHelperConstructor = incidentDbHelperClass.getConstructor(Context.class);

      dbHelper = (SQLiteOpenHelper) incidentDbHelperConstructor.newInstance(context);
  ...
  /**
   * >>>>>>> a6840f1... S07.03-Exercise-ConflictResolutionPolicy Tests the columns with null values
  ...
  public void testInsertSingleRecordIntoIncidentTable() {
    ...
    String expectedIncidentDidntMatchActual = "Expected incident values didn't match actual values.";
