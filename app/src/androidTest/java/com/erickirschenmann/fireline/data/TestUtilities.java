...
import static com.erickirschenmann.fireline.data.TestIncidentDatabase.REFLECTED_COLUMN_HUMIDITY;
import static com.erickirschenmann.fireline.data.TestIncidentDatabase.REFLECTED_COLUMN_MAX;
import static com.erickirschenmann.fireline.data.TestIncidentDatabase.REFLECTED_COLUMN_MIN;
import static com.erickirschenmann.fireline.data.TestIncidentDatabase.REFLECTED_COLUMN_PRESSURE;
import static com.erickirschenmann.fireline.data.TestIncidentDatabase.REFLECTED_COLUMN_WEATHER_ID;
import static com.erickirschenmann.fireline.data.TestIncidentDatabase.REFLECTED_COLUMN_WIND_DIR;
import static com.erickirschenmann.fireline.data.TestIncidentDatabase.REFLECTED_COLUMN_WIND_SPEED;
...
public class TestUtilities {
  ...
  static ContentValues createTestIncidentContentValues() {
    ...
    testIncidentValues.put(REFLECTED_COLUMN_WEATHER_ID, 321);
  ...
  static ContentValues[] createBulkInsertTestIncidentValues() {
    ...
    for (int i = 0; i < BULK_INSERT_RECORDS_TO_INSERT; i++) {
      ...
      bulkTestIncidentValues[i] = weatherValues;
    }
