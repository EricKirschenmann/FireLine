...
public class TestUtilities {
  ...
  static ContentValues createTestIncidentContentValues() {
    ...
    testIncidentValues.put(REFLECTED_COLUMN_INCIDENT_TYPE, "Traffic Collision");
    testIncidentValues.put(REFLECTED_COLUMN_LATITUDE, 34.1859410);
    testIncidentValues.put(REFLECTED_COLUMN_LONGITUDE, -118.9407850);
    testIncidentValues.put(REFLECTED_COLUMN_RESPONSE_DATE, "1/1/1979 1:00");
